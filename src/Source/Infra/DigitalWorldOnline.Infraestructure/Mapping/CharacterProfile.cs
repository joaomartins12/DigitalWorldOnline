...
namespace DigitalWorldOnline.Infraestructure.Mapping
{
    public class CharacterProfile : Profile
    {
        public CharacterProfile()
        {
            ...
            CreateMap<CharacterFriendModel, CharacterFriendDTO>().ReverseMap();

            CreateMap<CharacterFoeModel, CharacterFoeDTO>().ReverseMap();

            CreateMap<CharacterProgressModel, CharacterProgressDTO>().ReverseMap();
            
            CreateMap<InProgressQuestModel, InProgressQuestDTO>().ReverseMap();

            CreateMap<CharacterActiveEvolutionModel, CharacterActiveEvolutionDTO>().ReverseMap();
            
            CreateMap<CharacterDigimonArchiveModel, CharacterDigimonArchiveDTO>().ReverseMap();
            
            CreateMap<CharacterDigimonArchiveItemModel, CharacterDigimonArchiveItemDTO>().ReverseMap();

            CreateMap<CharacterArenaPointsModel, CharacterArenaPointsDTO>().ReverseMap();
            ...
            CreateMap<CharacterEncyclopediaModel, CharacterEncyclopediaDTO>().ReverseMap();

            CreateMap<CharacterEncyclopediaEvolutionsModel, CharacterEncyclopediaEvolutionsDTO>().ReverseMap();
        }
    }
}