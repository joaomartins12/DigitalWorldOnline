        ...
        public async Task Process(GameClient client, byte[] packetData)
        {
            ...
            if (weeklyRanking == null)
            {
                ...
                if (weeklyRanking != null)
                {
                    ...
                    if (client.Tamer.Inventory.RemoveOrReduceItem(removeItem, Points))
                    {
                        ...
                        foreach (var item in rewardsToReceive)
                        {
                            ...
                            {
                                targetItem.EndDate = DateTime.Now.AddDays(7);

                                client.Tamer.GiftWarehouse.AddItemGiftStorage(targetItem);
            ...
            else  monthlyRanking.AddPoints(Points);
            ...
            else seasonalRanking.AddPoints(Points);
        }
    }
}
