    ...
    public sealed class GameServer : Commons.Entities.GameServer, IHostedService
    {
        ...
        private void OnDisconnectEvent(object sender, GameClientEvent gameClientEvent)
        {
            if(gameClientEvent.Client.TamerId > 0)
            {
                ...
                {
                    _logger.Information($"Removing a tamer {gameClientEvent.Client.Tamer.Name} {gameClientEvent.Client.TamerId}. {gameClientEvent.Client.HiddenAddress}.");
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            ...
            Task.Run(() => _mapServer.CallDiscordWarnings("Server Online", "13ff00", "1124830217958068378", "1280691463297957899"));
