    ...
    public sealed partial class MapServer
    {
        public void TamerOperation(GameMap map)
        {
            ...
            foreach (var tamer in map.ConnectedTamers)
            {
                ...
                {
                    if (tamer.PvpMap && tamer.TargetPartner.Character.PvpMap) PartnerAutoAttackPlayer(tamer);
                }
                ...
                case TimeRewardIndexEnum.First:
                    {
                        ...
                        GetPrizes.ForEach(drop =>
                        {
                            ...
                            reward.EndDate = DateTime.Now.AddDays(7);
                        ...
                        client.Send(new NoticeMessagePacket($"You have received some gifts for playing on our server!"));
                    }
                    break;
                ...
                case TimeRewardIndexEnum.Fourth:
                    {
                        ...
                        client.Send(new NoticeMessagePacket($"You have received all of today's gifts. Thank you for appreciating our server."));
                    }
                    break;
        ...
        private void ReedemReward(GameClient client)
        {
            ...
            if (rewardInfo != null)
            {
                ...
                if (client.Tamer.Inventory.AddItem(newItem))
                {
                    ...
                    client.Send(new LoadAccountWarehousePacket(client.Tamer.Inventory));
                }
